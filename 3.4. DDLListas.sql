CREATE SEQUENCE seq_listas_pais START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_listas_provincia_estado START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_listas_ciudad START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_listas_artista START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_listas_grupo START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_listas_genero START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_listas_cancion START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_listas_lista START WITH 1 INCREMENT BY 1;
...
CREATE TABLE LISTAS_ARTISTA(
    ...
    NOM_ESTADO_PROV VARCHAR2(30),
    NOM_PAIS VARCHAR2(30),
    CONSTRAINT FK_ARTISTA FOREIGN KEY (NOM_ESTADO_PROV, NOM_PAIS, NOM_CIUDAD) REFERENCES LISTAS_CIUDAD
);

CREATE TABLE LISTAS_GRUPO(
    COD NUMBER(4) DEFAULT seq_listas_grupo.nextval PRIMARY KEY,
